...
vector< vector<pair<int, int> > > winning_states(8);
// All possible winning states
void set_state(){
winning_states[0].pb({0,0});
winning_states[0].pb({0,1});
winning_states[0].pb({0,2});
winning_states[1].pb({1,0});
winning_states[1].pb({1,1});
winning_states[1].pb({1,2});
winning_states[2].pb({2,0});
winning_states[2].pb({2,1});
winning_states[2].pb({2,2});
winning_states[3].pb({0,0});
winning_states[3].pb({1,0});
winning_states[3].pb({2,0});
winning_states[4].pb({0,1});
winning_states[4].pb({1,1});
winning_states[4].pb({2,1});
winning_states[5].pb({0,2});
winning_states[5].pb({1,2});
winning_states[5].pb({2,2});
winning_states[6].pb({0,0});
winning_states[6].pb({1,1});
winning_states[6].pb({2,2});
winning_states[7].pb({2,0});
winning_states[7].pb({1,1});
winning_states[7].pb({0,2});
